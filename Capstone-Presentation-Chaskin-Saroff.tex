...
\begin{frame}{Inner Product as a Matrix}
    ...
    $$
        E = \begin{pmatrix}
            \blu{E_{11}} & \tikzmark{left}E_{12}\tikzmark{right} & \cdots & E_{1n} \\
            \DrawBox[thick]
            \tikzmark{left}E_{12}\tikzmark{right} & \blu{E_{22}} & \cdots & E_{2n} \\
...
\begin{frame}{Dot Product on $\RR^3$}
    The Dot Product can be represented in the same way.
    \pause
    \\$\inp{e_i}{e_j} = 0$
    \pause
    \\$\inp{e_i}{e_i} = 1$
